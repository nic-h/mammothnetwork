...
async function init() {
  app = new PIXI.Application({ view: stageEl, backgroundColor:0x000000, antialias:true, resolution:Math.min(devicePixelRatio||1,2), width: stageEl.clientWidth, height: stageEl.clientHeight });
