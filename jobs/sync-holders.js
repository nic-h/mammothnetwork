...
import { fetchCollectionStats, fetchTokenIds, fetchHoldersViaMetadata, envEnabled } from './modularium.js';
...
async function main() {
  ...
  // Pull owners via metadata in parallel (lightweight owner only)
